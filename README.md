...
OpenAPI spec is auto-generated by `@fastify/swagger` and available at:

- **JSON:** `GET /documentation/json`
- **YAML:** `GET /documentation/yaml`

To visualize, import the spec into Postman, Insomnia, or paste it at [editor.swagger.io](https://editor.swagger.io).

Routes with Zod schemas are automatically documented. Example:
